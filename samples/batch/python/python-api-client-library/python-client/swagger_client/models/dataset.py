...
class Dataset(object):
    ...
    def __init__(self, _self=None, display_name=None, description=None, custom_properties=None, locale=None, created_date_time=None, last_action_date_time=None, kind=None, links=None, properties=None, content_url=None, status=None, _configuration=None):  # noqa: E501
