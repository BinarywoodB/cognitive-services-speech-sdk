...
class WebHook(object):
    ...
    def __init__(self, _self=None, display_name=None, description=None, custom_properties=None, properties=None, web_url=None, events=None, created_date_time=None, last_action_date_time=None, status=None, links=None, _configuration=None):  # noqa: E501
