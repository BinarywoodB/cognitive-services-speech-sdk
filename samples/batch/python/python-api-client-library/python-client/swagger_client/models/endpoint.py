...
class Endpoint(object):
    ...
    def __init__(self, _self=None, model=None, display_name=None, description=None, custom_properties=None, locale=None, created_date_time=None, last_action_date_time=None, properties=None, links=None, status=None, _configuration=None):  # noqa: E501
