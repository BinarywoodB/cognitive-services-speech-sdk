...
class SharedModel(object):
    ...
    def __init__(self, _self=None, display_name=None, description=None, locale=None, created_date_time=None, last_action_date_time=None, status=None, _configuration=None):  # noqa: E501
