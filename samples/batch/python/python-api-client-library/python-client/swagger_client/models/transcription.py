...
class Transcription(object):
    ...
    def __init__(self, _self=None, display_name=None, description=None, custom_properties=None, locale=None, created_date_time=None, last_action_date_time=None, content_urls=None, model=None, links=None, properties=None, content_container_url=None, dataset=None, status=None, _configuration=None):  # noqa: E501
