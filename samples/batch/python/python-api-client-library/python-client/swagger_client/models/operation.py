...
class Operation(object):
    ...
    def __init__(self, id=None, _self=None, created_date_time=None, last_action_date_time=None, status=None, result=None, error=None, _configuration=None):  # noqa: E501
