...
class Evaluation(object):
    ...
    def __init__(self, display_name=None, description=None, custom_properties=None, _self=None, created_date_time=None, last_action_date_time=None, model1=None, model2=None, dataset=None, transcription1=None, transcription2=None, links=None, locale=None, properties=None, status=None, _configuration=None):  # noqa: E501
