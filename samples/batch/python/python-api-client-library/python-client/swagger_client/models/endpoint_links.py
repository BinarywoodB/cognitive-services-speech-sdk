...
class EndpointLinks(object):
    ...
    def __init__(self, web_socket=None, _configuration=None):  # noqa: E501
    ...
    @property
    def web_socket(self):
        """Gets the web_socket of this EndpointLinks.  # noqa: E501

        The Speech SDK endpoint for long requests with multiple final results.  # noqa: E501

        :return: The web_socket of this EndpointLinks.  # noqa: E501
        :rtype: str
        """
        return self._web_socket

    @web_socket.setter
    def web_socket(self, web_socket):
        """Sets the web_socket of this EndpointLinks.

        The Speech SDK endpoint for long requests with multiple final results.  # noqa: E501

        :param web_socket: The web_socket of this EndpointLinks.  # noqa: E501
        :type: str
        """
