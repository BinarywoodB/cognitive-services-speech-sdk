...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranscriptionLinks', function() {
      beforeEach(function() {
        instance = new SpeechServicesApiVersion20241115.TranscriptionLinks();
      });

      it('should create an instance of TranscriptionLinks', function() {
        // TODO: update the code to test TranscriptionLinks
        expect(instance).to.be.a(SpeechServicesApiVersion20241115.TranscriptionLinks);
      });
