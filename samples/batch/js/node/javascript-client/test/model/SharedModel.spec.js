...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharedModel', function() {
      beforeEach(function() {
        instance = new SpeechServicesApiVersion20241115.SharedModel();
      });

      it('should create an instance of SharedModel', function() {
        // TODO: update the code to test SharedModel
        expect(instance).to.be.a(SpeechServicesApiVersion20241115.SharedModel);
      });
