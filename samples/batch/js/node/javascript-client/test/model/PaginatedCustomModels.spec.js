...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginatedCustomModels', function() {
      beforeEach(function() {
        instance = new SpeechServicesApiVersion20241115.PaginatedCustomModels();
      });

      it('should create an instance of PaginatedCustomModels', function() {
        // TODO: update the code to test PaginatedCustomModels
        expect(instance).to.be.a(SpeechServicesApiVersion20241115.PaginatedCustomModels);
      });
