...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EndpointLinks', 'model/EndpointProperties', 'model/EntityReference', 'model/Status'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EndpointLinks'), require('./EndpointProperties'), require('./EntityReference'), require('./Status'));
  } else {
    // Browser globals (root is window)
    if (!root.SpeechServicesApiVersion20241115) {
      root.SpeechServicesApiVersion20241115 = {};
    }
    root.SpeechServicesApiVersion20241115.Endpoint = factory(root.SpeechServicesApiVersion20241115.ApiClient, root.SpeechServicesApiVersion20241115.EndpointLinks, root.SpeechServicesApiVersion20241115.EndpointProperties, root.SpeechServicesApiVersion20241115.EntityReference, root.SpeechServicesApiVersion20241115.Status);
  }
}(this, function(ApiClient, EndpointLinks, EndpointProperties, EntityReference, Status) {
  'use strict';
