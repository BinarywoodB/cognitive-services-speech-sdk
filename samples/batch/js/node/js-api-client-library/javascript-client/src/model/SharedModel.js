...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SpeechServicesApiVersion20241115.SharedModel = factory(root.SpeechServicesApiVersion20241115.ApiClient, root.SpeechServicesApiVersion20241115.Status);
  }
}(this, function(ApiClient, Status) {
  'use strict';

  /**
   * The SharedModel model module.
   * @module model/SharedModel
   * @version 2024-11-15
   */

  /**
   * Constructs a new <code>SharedModel</code>.
   * @alias module:model/SharedModel
   * @class
  ...
  /**
   * Constructs a <code>SharedModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SharedModel} obj Optional instance to populate.
   * @return {module:model/SharedModel} The populated <code>SharedModel</code> instance.
   */
