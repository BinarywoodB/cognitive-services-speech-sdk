...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomModelDeprecationDates', function() {
      beforeEach(function() {
        instance = new SpeechServicesApiVersion20241115.CustomModelDeprecationDates();
      });

      it('should create an instance of CustomModelDeprecationDates', function() {
        // TODO: update the code to test CustomModelDeprecationDates
        expect(instance).to.be.a(SpeechServicesApiVersion20241115.CustomModelDeprecationDates);
      });
